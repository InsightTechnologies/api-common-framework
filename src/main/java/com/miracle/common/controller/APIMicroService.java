...
//	}
     ...
     */
     ...
     public RestTemplate restTemplate() {
             ...
             * 
             ...
             poolingHttpClientConnectionManager.setDefaultMaxPerRoute(this.property.getRestTemplateConfig().getDefaultMaxPerRoute());
             poolingHttpClientConnectionManager.setValidateAfterInactivity(this.property.getRestTemplateConfig().getValidateAfterInactivity());
             /**
             * 
	...
	public String getIceScrumURLPrefix()throws GatewayServiceException {
		String apiEndPoint = "";
		try {
			apiEndPoint = mongoDBUtility.getAPIEndPoint();
		} catch (Exception e) {
