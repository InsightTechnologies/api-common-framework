...
public class APIExceptionResponse {
	...
	public String toString() {
		return "APIExceptionResponse [timestamp=" + timestamp + ", errorCode=" + errorCode + ", errorDescription="
				+ errorDescription + ", uri=" + uri + ", stackTraceElement=" + stackTraceElement + ", completeTrace="
				+ completeTrace + ", statusCode=" + statusCode + "]";
	}
